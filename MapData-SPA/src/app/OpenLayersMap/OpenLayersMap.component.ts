import { Component, Output, Input, OnInit, NgZone, Renderer2, ViewChild, ElementRef } from '@angular/core';
...
@Component({
  ...
  styleUrls: ['./OpenLayersMap.component.css'],
})
...
export class OpenLayersMapComponent implements OnInit {
  ...
  initilizeMap() {
    ...
    this.map.on('pointermove', function (this, e) {
      ...
      if (hover) {
        hoverElement.innerHTML = '&nbsp;Hovering: ' + hover.get('name');
      } else {
